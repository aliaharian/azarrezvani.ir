                            ...
                            <div class="box box-solid">
                                ...
                                <div class="box-body no-padding">
                                    <div class="input-group" style="width: 100%;padding: 10px">
                                        <div id="picture" style="width: 100%;margin: 5px auto;"><img src="{{$photo->image}}" style="width: 100%;margin: 5px auto;"></div>
                                        ...
                                        <input type="text" hidden name="mainImage" style="width: 100%;height: 100%" value="{{$photo->image}}" id="featured_image" placeholder="آدرس تصویر" readonly />
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <input class="form-control" name="title" value="{{ $photo->title }}" id="title" placeholder="عنوان تصویر">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" name="video" value="{{ $photo->video }}" id="video" placeholder="کد آپارات">
                                    </div>
