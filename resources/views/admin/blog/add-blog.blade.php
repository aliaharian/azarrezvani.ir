                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <input class="form-control" name="title" id="title" placeholder="عنوان مقاله">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" name="author" id="author" placeholder="نام نویسنده">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" name="tags" id="tags" placeholder="تگ های مقاله: معلم,معلمی,آذر رضوانی">
                                    </div>
                                    <!-- <div class="form-group">
                                        <input class="form-control" name="slug" id="slug" placeholder="slug in english">
                                    </div> -->
                                    <div class="form-group">
                                        <textarea  name="brief" class="form-control" style="height: 300px">خلاصه مقاله</textarea>
                                    </div>
                                    <div class="form-group">
